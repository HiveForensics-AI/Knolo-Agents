...
- [ICP agent runtime ADR](architecture/adr-001-icp-agent-runtime.md), [constraints matrix](architecture/icp-constraints-matrix.md), [cost guide](architecture/icp-cost-guide.md), [security checklist](architecture/icp-security-checklist.md)

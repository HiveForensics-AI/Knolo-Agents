...
for the Knolo CLI dependency closure are maintained in
[`THIRD-PARTY-NOTICES`](../THIRD-PARTY-NOTICES).

This directory is only for **in-tree vendored** sources present in this
checkout. Update this manifest whenever another vendored crate is added.
